...
from typing import Any, Literal, NotRequired, Protocol, TypedDict, TypeGuard
...
def is_file_input(value: Any) -> TypeGuard[FileInputFixed]:
    ...
    return (
        isinstance(value, dict)
        and value.get("tool_type") == "file"
        and "file_path" in value
    )
...
# Example data
bash_data = {"tool_type": "bash", "command": "echo hello", "timeout": 30}
...
print(
    "3. ✅ Function contravariance: Implement specific type guards instead of generic ones"
)
print("4. ✅ Protocol variance: Use Protocol classes for flexible type relationships")
print(
    "5. ✅ Generic variance: Properly annotate type parameters with variance modifiers"
)
