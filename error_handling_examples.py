...
from typing import Any, Generic, TypeVar, Union, TypeAlias, Generator, Optional
...
DiscordError: TypeAlias = Union[DiscordAPIError, NetworkError]
...
def safe_file_operation(filepath: Path) -> Generator[Path, None, None]:
    ...
    try:
        ...
        logging.error(f"Unexpected error in file operation: {type(e).__name__}: {e}")
        raise
    finally:
